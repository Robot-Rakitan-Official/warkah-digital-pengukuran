...
<body class="flex items-center justify-center p-10 min-h-screen">
    <div class="bg-white rounded-xl shadow-sm border w-full max-w-4xl overflow-hidden">
        ...
        <div class="p-8 pb-4">
            <h2 class="text-2xl font-bold font-['Public_Sans'] text-[#110B45] mb-1">Tambah Peminjaman Baru</h2>
            <p class="text-sm text-gray-500 mb-6">Silakan lengkapi formulir di bawah ini untuk mencatat transaksi peminjaman dokumen gambar ukur baru dari sistem pengarsipan.</p>
        ...
        <form method="POST" class="p-8 pt-0">
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-3 gap-6 mb-4">
                    <div>
                        ...
                        <input type="text" name="no_gambar_ukur" placeholder="Contoh: 1234/Sleman/2023" class="w-full bg-[#F8FAFC] border border-gray-200 p-2.5 rounded-lg text-sm focus:outline-none focus:border-[#110B45]" required>
                    </div>
                    <div>
            ...
            <div class="flex justify-end gap-3 pt-6 bg-gray-50 -mx-8 -mb-8 px-8 py-5 border-t">
                <a href="transaksi.php" class="px-6 py-2.5 border border-gray-300 bg-white rounded-lg text-sm font-bold text-gray-700 hover:bg-gray-50">Batal</a>
                <button type="submit" name="simpan" class="bg-navy text-white px-6 py-2.5 rounded-lg text-sm font-bold hover:bg-opacity-90 flex items-center gap-2">
